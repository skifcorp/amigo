...
//    private static Logger logger = LoggerFactory.getLogger ( Server.class );
    ...
    public Server ( final ConnectionInformation connectionInformation )//, final ScheduledExecutorService scheduler )
    {
	 ...
	 /*   System.out.println( gnu.classpath.SystemProperties.getProperty("java.version") );
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.runtime.version") );
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.vendor"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.vendor.url"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.class.version"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.vm.specification.version"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.vm.specification.name"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.vm.specification.vendor"));
		System.out.println( gnu.classpath.SystemProperties.getProperty("java.vm.version"));
		System.out.println( gnu.classpath.SystemProperties.getProperty("java.vm.vendor"));
		System.out.println( gnu.classpath.SystemProperties.getProperty("java.vm.name"));
		System.out.println( gnu.classpath.SystemProperties.getProperty("java.specification.version"));
		System.out.println( gnu.classpath.SystemProperties.getProperty("java.specification.name"));
		System.out.println( gnu.classpath.SystemProperties.getProperty("java.specification.vendor"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.home"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("gnu.classpath.home" ));
        System.out.println( gnu.classpath.SystemProperties.getProperty("gnu.classpath.home.url" ));
        System.out.println( gnu.classpath.SystemProperties.getProperty("file.encoding" ));
        System.out.println( gnu.classpath.SystemProperties.getProperty("os.name"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("os.version"));
	    System.out.println( gnu.classpath.SystemProperties.getProperty("os.arch"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("os.name"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("os.arch"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("os.version"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("user.name"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("user.home"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("gnu.gcj.user.realname"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("user.dir"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("user.language"));
	    System.out.println( gnu.classpath.SystemProperties.getProperty("user.region"));	  	 	 
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.ext.dirs"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("gnu.gcj.runtime.endorsed.dirs"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("sun.boot.class.path"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("gnu.gcj.precompiled.db.path"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("gnu.gcj.progname"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.library.path"));
        System.out.println( gnu.classpath.SystemProperties.getProperty("java.class.path"));  */
		...
		//System.out.println( gnu.classpath.SystemProperties.getProperty("java.security.manager") ); 
		//gnu.classpath.SystemProperties.setProperty("java.security.manager", "default");
...
//        logger.info ( String.format ( "Socket timeout: %s ", socketTimeout ) );
        ...
        try
        {
            if ( this.connectionInformation.getClsid () != null )
            {
                ...
                //this.session.setInBuiltLogHandler(false);
